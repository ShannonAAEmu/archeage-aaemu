package com.aaemu.editor.service.netty.config;

import com.aaemu.editor.service.model.Account;
import com.aaemu.editor.service.netty.decoder.LengthFieldBasedFrameDecoder;
import com.aaemu.editor.service.netty.handler.ClientHandler;
import com.aaemu.editor.service.netty.handler.CodecHandler;
import com.aaemu.editor.service.netty.handler.ExceptionHandler;
import com.aaemu.editor.service.netty.handler.LoggingHandler;
...
public class ChannelConfig extends ChannelInitializer<SocketChannel> {
    ...
    @Value("${editor_server.hex_logger.active}")
    private boolean useHexLog;

    @Value("${editor_server.hex_logger.use_ignore_list}")

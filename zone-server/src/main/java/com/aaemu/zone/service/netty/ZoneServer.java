package com.aaemu.zone.service.netty;

import com.aaemu.zone.service.exception.ZoneServerException;
import com.aaemu.zone.service.netty.config.ChannelConfig;
    ...
    public void start() {
        try {
            ...
            if (bindFuture.isSuccess()) {
                log.info("Start zone server on port: {}", port);
            }
        } catch (Exception e) {
            throw new ZoneServerException(e);
        }
    }
